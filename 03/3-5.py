...
users = pd.read_csv('C:/Users/0000/Desktop/Recommendation_System/03/u.user',sep='|',names=u_cols,encoding='latin-1')
...
movies = pd.read_csv('C:/Users/0000/Desktop/Recommendation_System/03/u.item',sep='|',names=i_cols,encoding='latin-1')

r_cols = ['user_id','movie_id','rating','timestamp']
ratings = pd.read_csv('C:/Users/0000/Desktop/Recommendation_System/03/u.data',sep='\t',names=r_cols,encoding='latin-1')
...
counts = pd.taFrame(counts, index=rating_matrix.index, columns=rating_matrix.index).fillna(0)
...
item_similarity = pd.DataFrame(item_similarity, index=rating_matrix_t.index,columns=rating_matrix.index)
