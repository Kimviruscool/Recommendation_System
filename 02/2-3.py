...
#Data 읽기
movies = pd.read_csv('C:/Users/0000/Desktop/Recommendation_System/02/movies_metadata.csv', encoding='latin-1', low_memory=False)
movies = movies[['id','title','overview']]
movies.head(10)
# print(len(movies)) #데이터 확인
